...
//middleware secciones de codigo que permiten intercambiar informacion entre aplicaciones
...
app.use('/api/movies', require('./routes/movies')); // se va a usar la ruta que es la api de movies y su controlador
